...
> **Product-model notice (2026-07-13):** The mentorship terminology and data
> model later in this document describe the current legacy application. The
...
> Code remains canonical until that rebuild lands.
