...
- [Environments and dev/prod separation](environments.md) — why we run tests against `bridgecircle-dev`, not prod.
- [Seeding the dev database](seed-dev.md) — what test users are available and how to reset state.
- [Phase 1 launch spec](phase-1-launch-spec.md) — what flows need to be covered before launch.
