...
This document specifies what ships on top of `phase-1-launch-spec.md` between weeks 3 and 4. Target go-live for the full Phase 1 demo is 2026-05-25 (alumni board meeting).
...
- defaults at launch match `phase-1-spec.md`: name/year/city/employer/title/university/major org-visible; social/contact links friends-only
...
| 4 | Privacy UI, analytics, announcements, polish | full regression test the day before May 25 |
