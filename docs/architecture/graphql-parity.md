...
| Feature | Operations | `/lib` |
|---|---|---|
| members | `me`, `member(id)` | `loadMembersByIds` |
| openAsks | `myOpenAsk`, `createOpenAsk`, `closeOpenAsk` | `lib/asks/openAsks` |

Slices land feature by feature; each adds manifest entries here and there.
