...
- [Pre-onboarding experience](../product-spec-obsidian-vault/Prototype/pre-onboarding-experience.md) — invite/QR → signup + LinkedIn → locked first look → admin-triggered opening day (solves the directory cold-start)
