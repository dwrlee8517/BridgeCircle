...
- [Production migration ownership record](architecture/production-migration-ownership-record.md) — release-freeze evidence, no-op proof, and Supabase integration transfer
