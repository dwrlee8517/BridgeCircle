...
colors:
  ...
  error: "#9b2c1f"
  warning: "#c8761a"
  danger-accent: "#b9472a"
  success: "#3b6e51"
  category: "#722f37"
  primary-tint: "rgba(37, 99, 235, 0.10)"
  primary-tint-strong: "rgba(37, 99, 235, 0.16)"
  success-tint: "rgba(59, 110, 81, 0.10)"
  warning-tint: "rgba(200, 118, 26, 0.12)"
  danger-tint: "rgba(155, 44, 31, 0.10)"
  category-tint: "rgba(114, 47, 55, 0.10)"
...
- **Tertiary (#722f37) — Plum:** editorial categorization for secondary taxonomy (topics, content type). Not an alarm color.
...
- **Semantic palette:** `error` (#9b2c1f, destructive/declined), `warning` (#c8761a, attention without alarm), `success` (#3b6e51, open/accepted), `category` (#722f37, plum taxonomy). Warning is border/dot/fill-safe but not safe for small body text — use `on-surface` for warning copy.
...
- **Don't** use `warning` (#c8761a) as small body text on light backgrounds — its 3.3:1 contrast is border/dot/fill-only.
