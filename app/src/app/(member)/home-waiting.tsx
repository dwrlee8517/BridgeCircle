                ...
                <div className="mt-2.5 flex gap-2">
                  {item.kind === 'direct_ask' ? (
                    <Link
                      ...
                      className="inline-flex min-h-8 items-center rounded-full bg-[var(--action-weak)] px-3.5 text-xs font-bold text-[var(--action-weak-text)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring"
                    >
                      View ask
                    </Link>
                  ) : (
                    <>
                      <button
                        ...
                        className="min-h-8 rounded-full bg-[var(--action-weak)] px-3.5 text-xs font-bold text-[var(--action-weak-text)] disabled:opacity-55"
                      >
                        {busy ? 'Working…' : 'Accept'}
                      </button>
                      <button
                        ...
                        className="min-h-8 rounded-full bg-card px-3.5 text-xs font-semibold text-text-secondary shadow-[var(--ring-outline)] disabled:opacity-55"
                      >
                        Decline
                      </button>
                    </>
