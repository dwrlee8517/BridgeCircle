...
import type { HelpReportReason } from '@/lib/help/contracts'
import { cn } from '@/lib/utils'

const REASONS: { value: HelpReportReason; label: string }[] = [
...
export function HelpReportDialog({
  ...
  const [reason, setReason] = useState<HelpReportReason>('harassment')
