...
const buttonVariants = cva(
  "group/button bc-motion-control inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap outline-none select-none focus-visible:border-focus-ring focus-visible:ring-4 focus-visible:ring-focus-ring-muted active:opacity-80 disabled:pointer-events-none disabled:opacity-60 aria-busy:pointer-events-none aria-busy:opacity-80 aria-invalid:border-state-danger aria-invalid:ring-4 aria-invalid:ring-danger-tint dark:aria-invalid:border-state-danger/50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        // Offer — "give help" actions (Accept, Offer advice/mentorship). Sage.
        // Pairs with default/blue (ask, browse) and cta/amber (single commit).
