...
select extensions.is(
  ...
  array[
    ...
    'decide_admin_report', 'decide_membership', 'decide_membership_with_reason',
    'decide_offer', 'decline_profile_import', 'delete_admin_school_event', 'disconnect',
    ...
    'get_school_home', 'issue_invite', 'list_admin_reports', 'list_conversation_messages_after',
    ...
    'save_admin_school_event', 'save_admin_school_event_v2', 'save_ask_outcome_share', 'save_helper_preferences',
...
select extensions.is(
  ...
  array[
    ...
    'can_access_user_topic', 'can_download_account_export',
    'can_view_ask', 'can_view_conversation',
    'cancel_my_account_deletion', 'clear_my_onboarding_draft', 'complete_onboarding',
    'decide_membership',
    ...
    'is_blocked', 'is_connected', 'is_full_admin_of',
