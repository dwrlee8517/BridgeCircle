 ...
 *   npm install --no-save fontkit wawoff2 && node scripts/generate-brand-wordmark.mjs
 *
...
async function main() {
  ...
  const wordmark = (fill) => `<?xml version="1.0" encoding="UTF-8"?>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${total} ${height}" width="${total}" height="${height}">
